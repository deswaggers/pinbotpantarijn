...
class Generalplay(game.Mode):
    ...
    def __init__(self, game, priority):
        ...
        self.musicjes = ['2018_spacemusicnova', '2018_Starlight_achtergrondmuziekje',"2018_TheAlienWhistle_achtergrondmuziekje", "2018_CosmicMessages_achtergrondmuziekje", "2018_SpaceLoop_achtergrondmuziekje", \
...
## Switches regular gameplay
    ...
    def sw_Routlane_active(self,sw):
        self.game.sound.play("sound_2018_Roblox_death_sound_effect2")
        self.game.score(150)
        self.game.coils.TopFlash3.pulse(45)
        self.game.coils.LvisorGI.pulse(40)
