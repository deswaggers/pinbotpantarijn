...
class Generalplay(game.Mode):
    ...
    def __init__(self, game, priority):
       ...
       ''' ['2018_spacemusicnova', '2018_Starlight_achtergrondmuziekje',"2018_TheAlienWhistle_achtergrondmuziekje", "2018_CosmicMessages_achtergrondmuziekje", "2018_SpaceLoop_achtergrondmuziekje", \
